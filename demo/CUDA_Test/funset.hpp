...
int test_image_process_laplacian(); // 灰度图像边缘检测：拉普拉斯变换
...
int test_image_process_histogram_equalization(); // 灰度图像均衡化
...
int test_image_process_bgr2bgr565(); // 图像颜色空间转换：BGR --> BGR565
...
int test_image_process_bgr2gray(); // 图像颜色空间转换：BGR --> Gray
